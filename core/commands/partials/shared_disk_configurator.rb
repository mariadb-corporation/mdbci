...
class SharedDiskConfigurator
  ...
  def create_libvirt_disk_images(shared_disks)
    ...
    FileUtils.chmod 0o775, image_dir_path, verbose: true
    FileUtils.chmod 0o771, @configuration_path, verbose: true
    shared_disks.each do |disk|
      ...
      FileUtils.chmod 0o771, "#{image_dir_path}/#{disk_id}.img", verbose: true
